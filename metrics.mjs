  ...
  return {
    ...
    record(entry) {
      ...
      const row = {
        ...
        origin: entry.origin || null, agent: entry.agent || null,
        ms: Number.isFinite(entry.ms) ? entry.ms : null, stream: entry.stream === true, subject: entry.subject ? String(entry.subject).slice(0, 110) : null,
